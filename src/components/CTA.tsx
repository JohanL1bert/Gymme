...
export const CTA = () => {
  ...
  return (
    <section>
      <div
        className=" h-full bg-neutral-500 flex iPad:justify-center iPad:items-center iPad:flex-row mobile:flex-col
      ...
      >
        <div className="h-full ">
          <img
            ...
            mobileSmall:min-w-[270px] mobileSmall:max-w-[270px]"
          />
        </div>
        <div
        ...
        mobile:ml-[30px]  mobile:-translate-y-20
        mobileSmall:-translate-y-20 mobileSmall:gap-4 mobileSmall:ml-[10px] mobileSmall:max-w-[250px] mobileSmall:max-h-[236px]"
        >
          <div>
            <h3
